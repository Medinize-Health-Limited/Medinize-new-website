    ...
    <div class="hidden md:block flex h-screen flex-col justify-between border-e bg-gray-50">
      <div class="px-4 py-6">
        ...
        <nav aria-label="Main Nav" class="mt-6 flex flex-col space-y-6 hidden md:block">
          ...
          <nuxt-link to="/dashboard/services"
          ...
          <nuxt-link :class="[$route.path === '/dashboard/appointments' ? 'bg-green-500 text-white' : '']"
            to="/dashboard/appointments" class="flex items-center gap-2 rounded-lg px-4 py-2 text-sm text-gray-700">
      ...
      <div class="sticky inset-x-0 bottom-0 border-t border-gray-100">
        <div @click="logout" class="cursor-pointer flex items-center gap-2 bg-white p-4 hover:bg-gray-50">
          <img src="@/assets/img/signOutIcon.svg" alt="">

          <div>
            <p class="text-xl font-extralight text-xs">Sign Out</p>
          </div>
        </div>
      </div>
    </div>
